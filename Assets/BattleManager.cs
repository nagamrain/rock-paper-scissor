    ...
    void Update()
    {
        switch (state)
        {
            ...
            case State.Player2Select:
                ...
                {
                    player2.SetPlay(false);
                    player1.SelectedCharacter.animator.SetBool("Walk",true);    
                    player2.SelectedCharacter.animator.SetBool("Walk",true);
            ...
            case State.Attacking:
                ...
                {                   
                    ...
                    if (winner == null)
                    {
                        player1.SelectedCharacter.animator.SetBool("isWin",true);          
                        player1.TakeDamage(player2.SelectedCharacter.AttackPower);    
                        player2.SelectedCharacter.animator.SetBool("isWin",true);  
                    ...
                    {                                          
                        ...
                        winner.SelectedCharacter.animator.SetBool("isWin",true);
                        loser.SelectedCharacter.animator.SetBool("isLose",true);     
                    }
            ...
            case State.Damaging:
                if(player1.IsDamaging() == false && player2.IsDamaging() == false){
                    player1.SelectedCharacter.animator.SetBool("isWin",false);
                    player1.SelectedCharacter.animator.SetBool("isLose",false);    
                    player2.SelectedCharacter.animator.SetBool("isWin",false);
                    player2.SelectedCharacter.animator.SetBool("isLose",false);    
                    
                    if (player1.SelectedCharacter.CurrentHP == 0)
                    {
                        player1.SelectedCharacter.animator.SetBool("isDead",true);
                        player1.Remove(player1.SelectedCharacter);
                    }

                    if (player2.SelectedCharacter.CurrentHP == 0)
                    {
                        player2.SelectedCharacter.animator.SetBool("isDead",true);
                    ...
                    if (player1.SelectedCharacter != null)
                    {
                        player1.SelectedCharacter.animator.SetBool("isDead",false);
                        player1.SelectedCharacter.animator.SetBool("Walk",false);                                              
                        player1.Return();
                    }

                    if (player2.SelectedCharacter != null)
                    {
                        player2.SelectedCharacter.animator.SetBool("isDead",false);
                        player2.SelectedCharacter.animator.SetBool("Walk",false);                                             
                        player2.Return();
                    }    
